...
\lstdefinelanguage{Spark}{
  keywords={type, new, record, function, return, null, procedure, is, array, if, in, of, do, range, case, subtype, others, derives, from, package, own, initializes, inherit, hide},
